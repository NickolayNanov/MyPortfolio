export const projects = [
  {
    title: 'VTU Manager',
    description: "The VTU administration needed more modern software for managing their work so me and a frined of mine did this system for them. I did the back-end architecture by using DDD and making sure that all SOLID principles are beeing followed. As a database we use MSSQL Server and EF Core 5 as an ORM.",
      image: '/images/1.png',
